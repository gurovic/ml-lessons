...
=======
3. **Базовый синтаксис** — без walrus, сложных comprehensions и лишней обработки ошибок; комментарии на русском, кратко.
4. **pandas/numpy по справочнику** — во всех ноутбуках предпочитать базовые конструкции из **docs/pandas_numpy_basics.md**; более сложный API использовать только если этого требует тема урока.
>>>>>>> origin/main
